...
with beam.Pipeline('DirectRunner', options=opts) as p:
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT nconst, primaryProfession FROM imdb_modeled.People LIMIT 500'))
    ...
    qualified_table_name = PROJECT_ID + ':imdb_modeled.primaryProfessions_Beam'
