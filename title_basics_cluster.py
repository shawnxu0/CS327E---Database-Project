...
with beam.Pipeline('DataFlowRunner', options=opts) as p:
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT tconst,genres FROM imdb_modeled.title_basics'))
    ...
    qualified_table_name = PROJECT_ID + ':imdb_modeled.Genres_Beam_DF'
